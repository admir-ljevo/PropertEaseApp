...
namespace PropertEase.Infrastructure.Migrations
{
    ...
    public partial class UpdateEntities : Migration
    {
        ...
        {
            // This migration was regenerated from a stale model snapshot and contained
            // a full schema recreate that duplicated the initial migration.
            // All entity changes it described are already applied by earlier migrations.
        }

        private void _OriginalUp_DoNotCall(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProfilePhotoBytes = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApplicationUserId = table.Column<int>(type: "int", nullable: false),
                    HasSurveilance = table.Column<bool>(type: "bit", nullable: false),
                    Address = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PayPalPayerId = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Payments_PropertyReservations_ReservationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserRatings_AspNetUsers_RenterId",
                        column: x => x.RenterId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
        ...
        private void _OriginalDown_DoNotCall(MigrationBuilder migrationBuilder)
        {
