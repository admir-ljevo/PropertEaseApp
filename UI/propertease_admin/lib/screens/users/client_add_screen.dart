...
class UserAddScreen extends StatefulWidget {
  ...
  @override
  State<StatefulWidget> createState() => _UserAddScreenState();
}
...
class _UserAddScreenState extends State<UserAddScreen> {
  ...
  File? selectedImage;
  City? selectedCity;
  List<ApplicationRole> availableRoles = [];
  ...
  Future<void> _fetchRoles() async {
    ...
    setState(() {
      availableRoles = (result as dynamic).result.cast<ApplicationRole>();
      if (availableRoles.isNotEmpty) selectedRole = availableRoles[0];
    });
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text('Dodaj korisnika')),
      body: Form(
        key: _formKey,
                ...
                child: Column(
                  children: [
                    ...
                    Row(children: [
                      Expanded(
                          child: _field(
                              'Nacionalnost', _nationalityController,
                              required: false)),
                      const SizedBox(width: 16),
                      Expanded(
                          child: _field(
                              'Državljanstvo', _citizenshipController,
                              required: false)),
                    ]),
                  ],
                ),
              ...
              _SectionCard(
                ...
                child: Column(
                  children: [
                    ...
                    const SizedBox(height: 16),
                    DropdownButtonFormField<ApplicationRole>(
                      value: selectedRole,
                      decoration: const InputDecoration(
                          labelText: 'Uloga',
                          border: OutlineInputBorder()),
